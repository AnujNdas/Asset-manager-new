...
const SoftwareAssetList = () => {
  ...
  return (
    <div className="inventory-container">
      ...
      <AnimatePresence>
        {selectedAsset && (
          <motion.div className="overlay" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setSelectedAsset(null)}>
            <motion.div className="overlay-content view-modal" initial={{ scale: 0.96 }} animate={{ scale: 1 }} exit={{ scale: 0.96 }} onClick={(e) => e.stopPropagation()}>
              <div className="view-left icon-left">
              ...
              <div className="view-right">
                <h3 className="view-title">{selectedAsset.name || "Software"}</h3>
                ...
                <div className="view-details">
                  ...
                  <p><strong>Audit:</strong> {selectedAsset.auditHistory?.length ? selectedAsset.auditHistory.map(a => `${new Date(a.date).toLocaleDateString()}: ${a.notes}`).join(" | ") : "None"}</p>
                </div>
